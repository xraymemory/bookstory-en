...
Begin VB.Form Form62
  Caption = "Prevention for reading without buying"
  ScaleMode = 3
  AutoRedraw = False
  ...
  Begin Frame Frame3
    ...
    TabIndex = 4
    Begin Label Label1
      Caption = "   Prohibit reading in-store without buyingB"
      Index = 2
      Left = 120
      Top = 360
      Width = 1815
  ...
  Begin Frame Frame2
    ...
    TabIndex = 2
    Begin Label Label1
      Caption = "  Allow customers to read up to 1 book in-store before asking them to pay."
      Index = 1
      Left = 120
      Top = 360
      Width = 1815
  ...
  Begin Frame Frame1
    ...
    TabIndex = 0
    Begin Label Label1
      Caption = " Allow customers to read anything at will"
      Index = 0
      Left = 120
      Top = 360
      Width = 1815
