...
Begin VB.Form Form36
  ...
  Begin Frame Frame1
    ...
    Begin OptionButton Option5
      Caption = "FilthinessÇ™20à»è„Ç…Ç»Ç¡ÇΩÇÁClean up"
      Left = 120
      Top = 1200
      Width = 3015
      Height = 195
    ...
    Begin OptionButton Option4
      Caption = "FilthinessÇ™40à»è„Ç…Ç»Ç¡ÇΩÇÁClean up"
      Left = 120
      Top = 960
      Width = 3015
      Height = 195
    ...
    Begin OptionButton Option3
      Caption = "FilthinessÇ™60à»è„Ç…Ç»Ç¡ÇΩÇÁClean up"
      Left = 120
      Top = 720
      Width = 3015
      Height = 195
    ...
    Begin OptionButton Option2
      Caption = "FilthinessÇ™80à»è„Ç…Ç»Ç¡ÇΩÇÁClean up"
      Left = 120
      Top = 480
      Width = 3015
      Height = 195
  ...
  End
  Begin Frame Frame2
    Caption = "Choose cleaning method"
    Left = 3480
    Top = 480
    Width = 1335
    Height = 1455
